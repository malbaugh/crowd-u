...
class SubmitToContractAsTeam(Resource):
  ...
  def put(self,challenge_id,team_id):
    ...
    if (contract == None):
      ...
      for i in range(len(files)):
        filename = "submissions/" + contract.owner + "/" + challenge_id + "/teams/" + team.name + "/" + filenames[i]
      ...
      if (team.challenges == None):
        team.challenges = [contract.parent_id]
      else:
        team.challenges.append(contract.parent_id)
